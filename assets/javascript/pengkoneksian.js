                ...
                return $('#myBranch').DataTable({
                    ...
                    columnDefs: [{
                        ...
                        render: function render(data, type, row, meta) {
                            if (data == 'Pengkoneksian') {
                                return "<span class=\"badge badge-subtle badge-warning\">Pengkoneksian</span";
                            } else {
                        ...
                        targets: 13,
                        render: function render(data, type, row, meta) {
                            return "<button type=\"Batalkan verifikasi\" type=\"button\" class=\"btn btn-sm btn-icon btn-secondary\" title=\"Verifikasi Pengaktifan\"  data-toggle=\"modal\" data-target=\"#batalkan".concat(data, "\"><i class=\"far fa-check-circle\"></i></button>\n          <div class=\"modal modal-alert fade ml-2\" id=\"batalkan").concat(data, "\" data-backdrop=\"static\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"batalkanLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n      <div class=\"modal-content\">\n     <div class=\"modal-header\">\n      <h5 id=\"batalkanLabel\" class=\"modal-title\">\n     <i class=\"fa fa-bullhorn text-warning mr-1\"></i> Peringatan </h5>\n       </div>\n        <div class=\"modal-body\">\n        <p class=\"float-left mx-4 mt-2 mb-0\"> Apakah anda ingin memverfikasi pengaktifan site \"").concat(row.site_name, "\"? </p>\n       </div>\n        <div class=\"modal-footer\">\n      <button type=\"button\" class=\"btn btn-warning\" data-dismiss=\"modal\">Tidak!</button> <a type=\"button\" href=\"../manager/verifikasi_pengaktifan/").concat(data, "\" class=\"btn btn-subtle-primary\">Ya, verifikasi!</a>\n      </div>\n        </div>\n        </div>\n    </div>\n");
                        }
                    }]
                });
            }
