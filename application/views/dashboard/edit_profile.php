            ...
            <div class="page-inner">
                ...
                <header class="page-title-bar">
                    ...
                    <div class="d-md-flex align-items-md-start mt-4">
                        <h1 class="page-title mr-sm-auto"> Edit User </h1>
                ...
                <div class="page-section">
                    ...
                    <div class="card card-fluid">
                        <div class="card-body">
                            <form action="<?= base_url('dashboard/update_user/') . $user['id_user']; ?> " method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <!-- grid column -->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="email">Email</label> <input type="email" class="form-control" id="email" name="email" required="" value="<?= $user['email']; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="img-br" class="custom-file-input" id="img-br" value="<?= $user['image']; ?>"> <label class="custom-file-label" for="img-br">Choose file</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 mt-4">
                                        <img class="img-thumbnail" src="<?= base_url('assets/images/avatars/') . $user['image']; ?>" id="preview">
                                    </div>
                                    <div class="col-sm-12 mt-4">
                                        <button class="btn btn-primary" style="float: right;" type="submit">Simpan</button>
                                        <a href="<?= base_url('dashboard') ?>"><button type="button" class="btn btn-secondary">Kembali</button></a>
                                    </div>
                                </div><!-- /.form-row -->
                            </form>
                        </div>
