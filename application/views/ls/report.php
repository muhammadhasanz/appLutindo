<?php $this->load->view('ls/navreport');  ?>
                        <div class="card-body">
                            ...
                            <!-- #modalFilterColumns -->
                            <form target="_blank" action="<?= base_url('ls/excel'); ?> " method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="myReport" class="table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:50px; min-width:50px;"> Sales </th>
                                                <th style="width:50px; min-width:50px;"> Ket </th>
