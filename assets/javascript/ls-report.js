        ...
        _createClass(DataTablesBranch, [{
            ...
            value: function table() {
                return $('#myLogistic').DataTable({
                    ...
                    autoWidth: false,
                    ajax: '../administrator/getrequestlengkap',
                    deferRender: true,
                    // order: [1],
                    columns: [{
                        data: 'no',
