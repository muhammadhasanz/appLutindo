            ...
            <div class="page-inner">
                ...
                <div class="page-section">
                    ...
                    <div class="card card-fluid">
                        <div class="card-body">
                            <form action="<?= base_url('admin/update_user/') . $branch['id_user']; ?> " method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <!-- grid column -->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="email">Email</label> <input type="email" class="form-control" id="email" name="email" required="" value="<?= $branch['email']; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="img-br" class="custom-file-input" id="img-br" value="<?= $branch['image']; ?>"> <label class="custom-file-label" for="img-br">Choose file</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 mt-4">
                                        <img class="img-thumbnail" src="<?= base_url('assets/images/avatars/') . $branch['image']; ?>" id="preview">
                                    </div>
